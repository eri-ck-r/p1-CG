...
struct ImTextureData
{
  ...
  void* GetPixels()
  {
    IM_ASSERT(Pixels != NULL); return Pixels;
  }
  void* GetPixelsAt(int x, int y)
  {
    IM_ASSERT(Pixels != NULL); return Pixels + (x + y * Width) * BytesPerPixel;
  }
  ...
  {
    ImTextureRef tex_ref; tex_ref._TexData = this; tex_ref._TexID = ImTextureID_Invalid; return tex_ref;
  }
...
struct ImFontGlyph
{
  ...
  ImFontGlyph()
  {
    memset(this, 0, sizeof(*this)); PackId = -1;
  }
};
...
struct ImFontAtlas
{
  ...
  {
    IM_ASSERT(TexRef._TexID == ImTextureID_Invalid); TexRef._TexData->TexID = id;
  }                               // Called by legacy backends. May be called before texture creation.
  void            SetTexID(ImTextureRef id)
  {
    IM_ASSERT(TexRef._TexID == ImTextureID_Invalid && id._TexData == NULL); TexRef._TexData->TexID = id._TexID;
  ...
  {
    *out_uv_min = r->uv0; *out_uv_max = r->uv1;
  }             // OBSOLETED in 1.92.X
